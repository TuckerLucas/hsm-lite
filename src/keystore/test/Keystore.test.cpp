...
TEST_CASE("Update key data succesively successful")
{
    ...
    KeyData newUpdatedData = {0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
                              0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
                              0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11};

    vector<uint8_t> expectedHashOriginalUpdatedData = {
        0x47, 0x73, 0xd1, 0x2e, 0x23, 0x71, 0xbb, 0x93, 0x5b, 0x9a, 0x0f,
        0x54, 0x39, 0xb4, 0xa1, 0xc3, 0xad, 0x3f, 0x24, 0x14, 0xb8, 0x69,
        0x80, 0xf8, 0x41, 0x8d, 0x1c, 0xfa, 0xbd, 0xfa, 0xdf, 0xef};
...
TEST_CASE("Update key with same data fails")
{
    ...
    REQUIRE(keystore.updateKey(injectedKey.id, TestVectors::keyData32B) ==
            StatusCode::DuplicateKeyData);
}
...
TEST_CASE("Key equality")
{
    ...
    Key key1{12U, TestVectors::keyData32B}, key2{12U, TestVectors::keyData32B},
        key3{12U, TestVectors::keyData16B}, key4{13U, TestVectors::keyData16B};
