...
optional<vector<uint8_t>> Cryptography::aesEncrypt(const Key& key, const vector<uint8_t>& plainText,
...
optional<vector<uint8_t>> Cryptography::aesDecrypt(const Key& key,
...
optional<vector<uint8_t>> Cryptography::aesCrypt(const Key& key, const vector<uint8_t>& input,
                                                 AesKeySize aesKeySize, CipherMode aesMode,
